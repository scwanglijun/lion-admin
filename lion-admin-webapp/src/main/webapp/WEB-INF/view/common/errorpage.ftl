...
<script src="${base}/resources/admin/scripts/system/unauthorized.js" type="text/javascript"></script>
</head>
	...
	<div class="portlet-body">
		<div class="row">
			<div class="col-md-12 margin-top-10">
			 	<div class="alert alert-danger"><strong>错误提示：</strong>您访问页面出错，如需访问请联系系统管理员。</div>
			</div>
	</div>
</div>
